...
<div class="projects-matrix" in:fade>
    ...
    <div class="matrix-header">
        <div class="header-info">
            ...
            <p>
                Real-time lifecycle monitoring of your high-precision project
                portfolio.
            </p>
        </div>
    ...
    <div class="grid-engine">
        <div class="priority-row">
            {#each projects.filter((p) => p.layout !== "small") as p, i}
                <div
                    class="card-p {p.layout} card-hover"
                    in:fly={{ y: 30, delay: i * 150 }}
                >
                    <div class="p-body">
                        <div class="p-top">
                            <span class="p-badge {getStatusClass(p.status)}"
                                >{p.status}</span
                            >
                        ...
                        <div class="p-metrics">
                            ...
                            <div class="m-track">
                                <div
                                    class="m-fill"
                                    style="width: {p.percent}%; background: {p.statusColor}"
                                ></div>
                            </div>
                        </div>
                            ...
                            <div class="p-footer">
                                ...
                                <div class="f-team">
                                    <div class="avatars-mini">
                                        <div
                                            class="a-pfp"
                                            style="background-image: url('https://i.pravatar.cc/150?u=a')"
                                        ></div>
                                        <div
                                            class="a-pfp"
                                            style="background-image: url('https://i.pravatar.cc/150?u=b')"
                                        ></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="p-sidebar">
                            ...
                            <div class="s-block">
                                ...
                                <div class="s-team">
                                    <div
                                        class="a-pfp"
                                        style="background-image: url('https://i.pravatar.cc/150?u=1')"
                                    ></div>
                                    <div
                                        class="a-pfp"
                                        style="background-image: url('https://i.pravatar.cc/150?u=2')"
                                    ></div>
                                    <div
                                        class="a-pfp"
                                        style="background-image: url('https://i.pravatar.cc/150?u=3')"
                                    ></div>
                                    <div class="a-more">
                                        +{(p.teamSize ?? 3) - 3}
                                    </div>
                            ...
                            <button class="btn-log-action"
                                >Live Production Log <ArrowUpRight
                                    size={14}
                                /></button
                            >
                        </div>
            ...
            {#each projects.filter((p) => p.layout === "small") as p, i}
                ...
                >
                    <div class="p-body">
                        ...
                        <div class="p-metrics">
                            <div class="m-vals">
                                <span>{p.metricLabel}</span><span class="v"
                                    >{p.percent}%</span
                                >
                            </div>
                            <div class="m-track">
                        ...
                        <div class="p-footer-mini">
                            <div class="f-date">
                                <Calendar size={14} />
                                {p.deadline || "Completed"}
                            </div>
                            <div class="avatars-mini">
                                <div
                                    class="a-pfp"
                                    style="background-image: url('https://i.pravatar.cc/150?u=x')"
                                ></div>
                                <div
                                    class="a-pfp"
                                    style="background-image: url('https://i.pravatar.cc/150?u=y')"
                                ></div>
                            </div>
                        </div>
                    </div>
