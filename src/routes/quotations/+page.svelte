<script lang="ts">
    ...
    let quotations = $state([
        {
            id: "#QT-88219",
            name: "High-Precision Turbine Housing",
            status: "PENDING",
            amount: "$14,250.00",
            date: "Oct 24, 2023",
            active: true,
        ...
        {
            id: "#QT-87912",
            name: "Conveyor Belt Guide Rails",
            status: "PENDING",
            amount: "$12,400.00",
            date: "Oct 05, 2023",
            active: false,
            ...
            {#each quotations as q, i}
                ...
                >
                    <div class="card-left">
                        ...
                        <div class="card-meta">
                            <div class="meta-item">
                                <span class="label">AMOUNT</span><span
                                    >{q.amount}</span
                                >
                            </div>
                            <div class="meta-item">
                                <span class="label">DATE ISSUED</span><span
                                    >{q.date}</span
                                >
                            </div>
                        </div>
                    ...
                    <div class="card-right">
                        <span class="q-status {getStatusClass(q.status)}"
                            >{q.status}</span
                        >
            ...
            <div class="summary-card card-premium" in:fly={{ x: 20 }}>
                ...
                <div class="summary-info">
                    ...
                    <span class="project-hint"
                        >Project: {selectedQuotation.project}</span
                    >
                </div>
                ...
                <div class="validity-box">
                    ...
                    <p>
                        This quotation is valid for {selectedQuotation.validity}.
                        Prices include standard quality certification and
                ...
                <div class="summary-actions">
                    <button class="btn-approve">
                        <CircleCheck size={18} /> Approve Quotation
                    </button>
...
<style>
    ...
    .quo-card.active {
        border-color: #654dcf30;
        box-shadow: 0 20px 40px rgba(101, 77, 207, 0.04);
        background: rgba(101, 77, 207, 0.01);
    }
    .quo-card:hover {
    ...
    .help-banner {
        ...
        align-items: center;
        color: white;
        box-shadow: 0 20px 40px rgba(101, 77, 207, 0.2);
    }
    .h-text strong {
        display: block;
        font-size: 15px;
